...
Merci d'avoir téléchargé RetroBound!

Il y a deux .ttf .
Le premier "RetroBound.ttf" contient la police de caractère basique avec les lettres en minuscules.
La seconde "RetroBoundUC.ttf" contient la police de caractère avec uniquement des majuscules, mais les lettres minuscules ne comportent pas les décorations des lettres majuscules. 

RetroBound est gratuit pour n'importe quel usage, personnel ou professionnel.

Cette police de caractère a au début servi pour un projet personnel de jeu vidéo, et je me suis dis qu'il pourrait servir à d'autres personnes pour diverses utilisations! Donc je l'ai partagé.

Ce n'est pas une obligation, mais vous pouvez me créditer sur vos oeuvres au nom de "Exa" si vous le souhaitez, ça me ferait extrêmement plaisir! :)

J'espère qu'il vous sera d'un bon usage!

Je serais ravie de voir vos œuvres, quel qu'elles soient. N'hésitez pas à me partager vos créations, j'en serais très heureuse!
